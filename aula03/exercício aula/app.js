...
let pos = brazilianFoods.indexOf('null');
brazilianFoods.splice(pos, 1);
brazilianFoods.splice (1, 0, 'Pão de queijo')
//console.log(brazilianFoods)
...
*/
const foodsInfo = 'até aqui, o array \'brazilianFoods\' possui NOME_DO_ITEM_1, NOME_DO_ITEM_2 E NOME_DO_ITEM_3'
//console.log(foodsInfo.indexOf('array'))
//console.log(${foodsInfo.slice(0, foodsInfo.indexOf('NUMERO_DE_ITENS'))}${brazilianFoods.legt} items: ${brazilianFoods.toString()}.)
...
*/
//let dogNames = ["nome1", "nome2", "nome3", "nome4"];
...
*/
//let part1 = dogNames[0].substring(0, 2); 
//let part2 = dogNames[1].substring(1, 3); 
//let part3 = dogNames[3].substring(2, 4); 
//let dessert = part1 + part2 + part3;
//dessert = dessert.replace('n', 'd');
