...
*/
const my3FavoriteTVShows = ['Vingadores, Star wars e Liga da justiça'];
const sentence = "Minhas 3 séries favoritas são: SÉRIE_01, SÉRIE_02 e SÉRIE_03."
...
/*
  ...
  - Exiba no console um boolean indicando se o array de séries que você criou  
    possui 3 itens.
*/
let boolexiste = my3FavoriteTVShows.length == 3
console.log(boolexiste)
...
const isRandomTVShowIncluded = 'two and a half man'
console.log(`A série ${isRandomTVShowIncluded}, está presente no array?
${my3FavoriteTVShows.includes(isRandomTVShowIncluded)}`)
...
*/
const typeSentence = 'O tipo de dado que a const \'isRandomTVShowIncluded\
armazena é: Tipagem_De_Dado';

let TemptytypeSentence
...
*/
let numChar = 39;
console.log(`a string que a "typesentence" armazena tem mais de ${numChar}
...
console.log(`A soma do primeiro e terceiro item do array "ages" é ${agesSum}.`);
...
*/
const isNotAString = !typeof isRandomTVShow;
console.log(`O tipo de \"randomShow\" é: ${isNotAString}.`)
...
const hasEight = evenNumbers.indexOf(8) !== -1;
