...
*/
/*
let strq03 ='grandes poderes trazem grandes responsabilidades'
console.log(strq03)
...
//console.log('A última letra é: ' + lastLetter);
...
- Exiba, no console, o index do caractere "w" da "winterMessage";
*/
//const winterMessage = 'o inverno está chegando'
//const w = winterMessage[winterMessage.length - 1] 
//console.log(winterMessage.indexOf(w))
...
*/
//const winterMessage = 'o inverno está chegando';
//const n = winterMessage.lastIndexOf('n');
//console.log(n)
...
let episodes = 6
//let atualização = 4
//console.log(episodes += atualização)
...
//let newName = name.replace(/\b\w/g, (char) => char.toUpperCase());
//console.log(newName);
