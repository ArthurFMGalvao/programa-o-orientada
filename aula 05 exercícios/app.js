...
//const isSoma337 = soma === 337;
//console.log(isSoma337);
//A função 'parseInt' produz um valor inteiro ditado pela interpretação do conteúdo de uma argumento string de acordo com uma base específicada
/*
...
// Percorrendo os arrays aninhados
for (let i = 0; i < arrays.length; i++) {
  for (let j = 0; j < arrays[i].length; j++) {
    totalSoma += arrays[i][j];
  }
}
